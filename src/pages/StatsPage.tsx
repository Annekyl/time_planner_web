...
export default function StatsPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <h1 className="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:mb-6 fade-in">数据统计</h1>
          ...
          <div className="flex items-end gap-1 md:gap-2 h-32 md:h-40">
            {stats.dailyCompletions.map((day, i) => (
              <div key={i} className="flex-1 flex flex-col items-center gap-0.5 md:gap-1">
                ...
                <div
                  className="w-full bg-indigo-500 rounded-t transition-all duration-500 min-h-[4px] hover:bg-indigo-600"
                  style={{ height: `${(day.count / stats.maxDailyCount) * 100}%`, transitionDelay: `${i * 50}ms` }}
                />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6 card-hover fade-in" style={{ animationDelay: '0.25s' }}>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6 card-hover fade-in" style={{ animationDelay: '0.3s' }}>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6 card-hover fade-in" style={{ animationDelay: '0.35s' }}>
          ...
          <div className="space-y-2">
            ...
            <div className="w-full bg-gray-200 rounded-full h-3 mt-2 overflow-hidden">
              <div className="bg-indigo-500 h-3 rounded-full progress-bar" style={{ width: `${stats.avgGoalProgress}%` }} />
            </div>
          </div>
        </div>
      </div>
