      ...
      {isOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm" onClick={onClose}>
          <motion.div 
            ...
            className="glass w-full max-w-2xl p-6 md:p-8 rounded-3xl relative max-h-[85vh] flex flex-col"
...
function GuideItem({ icon: Icon, title, desc }: { icon: any, title: string, desc: string }) {
  return (
    <div className="flex gap-4 p-4 rounded-2xl bg-white/40 dark:bg-gray-800/40 border border-white/20 dark:border-gray-700/30 hover:bg-white/60 dark:hover:bg-gray-800/60 transition-colors">
